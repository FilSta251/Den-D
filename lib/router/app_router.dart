...
class AppRoutes {
  ...
  static bool isCriticalRoute(String routeName) => _criticalRoutes.contains(routeName);
  
  /// Kontroluje, zda je trasa náročná (má být prefetchována)
  static bool isHeavyRoute(String routeName) => _heavyRoutes.contains(routeName);
  
  /// NOVÉ: Kontroluje, zda je trasa náchylná k chybám
  static bool isErrorProneRoute(String routeName) => _errorProneRoutes.contains(routeName);
}
...
class AppRouter {
  ...
  static final LRUCache<String, Widget> _widgetCache = LRUCache<String, Widget>(maxSize: 10);
  ...
  static void initialize() {
    try {
      ...
      debugPrint('Varování: CrashReportingService není dostupný, navigace nebude měřena');
    }
  }
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    try {
      ...
      if (errorCount >= _maxErrorsPerRoute) {
        ...
        return _createFallbackRoute(routeName, 'Příliš mnoho chyb pro tuto obrazovku');
      }
  ...
  static Widget _wrapWithErrorBoundary(Widget widget, String routeName) {
    return ErrorBoundary(
      ...
      errorBuilder: (error) => CustomErrorWidget(
        ...
        detailMessage: 'Došlo k chybě na obrazovce $routeName: ${error.toString()}',
      ),
    );
  }
  ...
  static Widget _resolveWidget(RouteSettings settings) {
    ...
    // Pro kritické trasy vždy vytvoříme novou instanci
    ...
    try {
      switch (settings.name) {
        ...
        case AppRoutes.onboarding:
          return OnboardingScreen(userRepository: locator<UserRepository>());
      ...
      return CustomErrorWidget(
        ...
        detailMessage: 'Obrazovka ${settings.name} se nepodařila načíst: ${e.toString()}',
      );
    }
  }
  ...
  static Route<dynamic> _createFallbackRoute(String routeName, String reason) {
    return MaterialPageRoute(
      builder: (context) => Scaffold(
        appBar: AppBar(
          title: const Text('Obrazovka nedostupná'),
        ...
        body: CustomErrorWidget(
          ...
          detailMessage: 'Obrazovka $routeName byla dočasně zakázána kvůli opakovaným chybám. Důvod: $reason',
      ...
      if (_crashReporting != null) {
        _crashReporting!.addBreadcrumb(
          ...
          data: {
            ...
            'arguments': settings.arguments != null ? settings.arguments.toString() : null,
